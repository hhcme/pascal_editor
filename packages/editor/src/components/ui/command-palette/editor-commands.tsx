...
export function EditorCommands() {
  ...
  useEffect(() => {
    ...
    return register([
      ...
      {
        id: 'editor.tool.sketch-circle',
        label: '草图圆工具',
        group: '草图',
        icon: <Circle className="h-4 w-4" />,
        keywords: ['sketch', 'circle', 'radius', 'cad'],
        execute: () => activateTool('sketch-circle'),
      },
      {
        id: 'editor.tool.sketch-arc',
        label: '草图圆弧工具',
        group: '草图',
        icon: <PencilLine className="h-4 w-4" />,
        keywords: ['sketch', 'arc', 'curve', 'cad'],
        execute: () => activateTool('sketch-arc'),
      },
      {
